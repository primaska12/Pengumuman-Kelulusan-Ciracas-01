          ...
          <header className="flex flex-col items-center text-center w-full max-w-4xl mx-auto mb-6 md:mb-8 mt-4 sm:mt-0">
            ...
            >
              <motion.img 
                ...
                className="w-[100px] h-[100px] sm:w-[150px] sm:h-[150px] object-contain mb-2 sm:mb-4 drop-shadow-md"
                onError={(e) => {
            ...
            <motion.div 
              ...
              className={`relative backdrop-blur-2xl border border-white/60 mx-auto w-full transition-all duration-500 ${
                searchResult 
                  ...
                  : 'bg-white/70 max-w-[620px] p-6 sm:p-10 rounded-[32px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05),0_0_40px_-10px_rgba(37,99,235,0.1)]'
              }`}
            >
                      ...
                      <div className="mb-6 flex flex-col items-center justify-center p-4 sm:p-5 bg-blue-50/50 border border-blue-100 rounded-2xl mx-auto w-fit max-w-full min-w-[280px]">
                        ...
                        {releaseDate && (
                          <div className="bg-white border border-blue-100 px-4 py-2 rounded-lg mb-4 mt-2 shadow-sm inline-flex items-center">
                            <p className="text-blue-700 text-xs sm:text-sm font-semibold text-center leading-relaxed">
                        ...
                        <div className="flex items-center justify-center gap-1.5 sm:gap-3 w-full">
                          <div className="flex flex-col items-center justify-center bg-[#1e293b] rounded-xl sm:rounded-2xl w-[38px] h-[46px] sm:w-[50px] sm:h-[60px] shadow-sm">
                            <span className="text-sm sm:text-lg font-bold text-white mb-0.5">{countdownData.days}</span>
                            <span className="text-[8px] sm:text-[10px] text-slate-400 font-medium tracking-wide">Hari</span>
                          </div>
                          <div className="flex flex-col items-center justify-center bg-[#1e293b] rounded-xl sm:rounded-2xl w-[38px] h-[46px] sm:w-[50px] sm:h-[60px] shadow-sm">
                            <span className="text-sm sm:text-lg font-bold text-white mb-0.5">{countdownData.hours}</span>
                            <span className="text-[8px] sm:text-[10px] text-slate-400 font-medium tracking-wide">Jam</span>
                          </div>
                          <div className="flex flex-col items-center justify-center bg-[#1e293b] rounded-xl sm:rounded-2xl w-[38px] h-[46px] sm:w-[50px] sm:h-[60px] shadow-sm">
                            <span className="text-sm sm:text-lg font-bold text-white mb-0.5">{countdownData.minutes}</span>
                            <span className="text-[8px] sm:text-[10px] text-slate-400 font-medium tracking-wide">Menit</span>
                          </div>
                          <div className="flex flex-col items-center justify-center bg-[#1e293b] rounded-xl sm:rounded-2xl w-[38px] h-[46px] sm:w-[50px] sm:h-[60px] shadow-sm">
                            <span className="text-sm sm:text-lg font-bold text-white mb-0.5">{countdownData.seconds}</span>
                            <span className="text-[8px] sm:text-[10px] text-slate-400 font-medium tracking-wide">Detik</span>
                          </div>
                        </div>
                      </div>
                    ) : null}
                  ...
                  >
                    <div className="pt-2">
                       <motion.div 
                         ...
                         className={`w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-[0_8px_16px_rgba(16,185,129,0.25)] relative ${searchResult.status === 'Lulus' ? 'bg-[#10b981]' : 'bg-red-500'}`}
                       >
                       ...
                       >
                         ...
                         <ResultRow label="NISN" value={searchResult.nisn} />
                       ...
                       <motion.button
                         ...
                         onClick={resetSearch}
                         className="w-full h-[52px] flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-900 text-white shadow-md rounded-[16px] text-sm sm:text-base font-semibold transition-all active:scale-[0.98]"
                       >
