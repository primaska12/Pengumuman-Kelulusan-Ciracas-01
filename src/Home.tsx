          ...
          <header className="flex flex-col items-center text-center w-full max-w-4xl mx-auto mb-3 sm:mb-8 mt-2 sm:mt-0">
            ...
            >
              ...
              <h3 className="text-lg sm:text-3xl font-bold tracking-tight text-slate-800 mb-3 sm:mb-4 flex flex-col items-center">
                 <span>KELAS VI</span>
                 <span className="text-[9px] sm:text-sm mt-1 sm:mt-1.5 font-bold text-slate-500 tracking-[0.1em] sm:tracking-[0.2em] uppercase">Tahun Pelajaran 2025 / 2026</span>
              </h3>
            </motion.div>
          </header>
        )}
            ...
            <motion.div 
              ...
              className={`relative backdrop-blur-2xl border border-white/60 mx-auto w-full transition-all duration-500 ${
                searchResult 
                  ...
                  : 'bg-white/70 max-w-[620px] p-5 sm:p-10 rounded-[24px] sm:rounded-[32px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05),0_0_40px_-10px_rgba(37,99,235,0.1)]'
              }`}
            >
                    ...
                    {isLocked && countdownData ? (
                      <div className="mb-4 sm:mb-6 flex flex-col items-center justify-center p-3 sm:p-5 bg-blue-50/50 border border-blue-100 rounded-2xl mx-auto w-fit max-w-full min-w-[280px]">
                        ...
                        <div className="flex items-center justify-center gap-1.5 sm:gap-3 w-full">
                          <div className="flex flex-col items-center justify-center bg-[#1e293b] rounded-xl sm:rounded-2xl w-[32px] h-[40px] sm:w-[50px] sm:h-[60px] shadow-sm">
                            <span className="text-xs sm:text-lg font-bold text-white mb-0.5">{countdownData.days}</span>
                            <span className="text-[7px] sm:text-[10px] text-slate-400 font-medium tracking-wide">Hari</span>
                          </div>
                          <div className="flex flex-col items-center justify-center bg-[#1e293b] rounded-xl sm:rounded-2xl w-[32px] h-[40px] sm:w-[50px] sm:h-[60px] shadow-sm">
                            <span className="text-xs sm:text-lg font-bold text-white mb-0.5">{countdownData.hours}</span>
                            <span className="text-[7px] sm:text-[10px] text-slate-400 font-medium tracking-wide">Jam</span>
                          </div>
                          <div className="flex flex-col items-center justify-center bg-[#1e293b] rounded-xl sm:rounded-2xl w-[32px] h-[40px] sm:w-[50px] sm:h-[60px] shadow-sm">
                            <span className="text-xs sm:text-lg font-bold text-white mb-0.5">{countdownData.minutes}</span>
                            <span className="text-[7px] sm:text-[10px] text-slate-400 font-medium tracking-wide">Menit</span>
                          </div>
                          <div className="flex flex-col items-center justify-center bg-[#1e293b] rounded-xl sm:rounded-2xl w-[32px] h-[40px] sm:w-[50px] sm:h-[60px] shadow-sm">
                            <span className="text-xs sm:text-lg font-bold text-white mb-0.5">{countdownData.seconds}</span>
                            <span className="text-[7px] sm:text-[10px] text-slate-400 font-medium tracking-wide">Detik</span>
                          </div>
                        </div>
                      </div>
                    ) : null}
                  ...
                  >
                    <div className="pt-2">
                       <motion.div 
                         ...
                         className={`w-14 h-14 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-6 shadow-[0_8px_16px_rgba(16,185,129,0.25)] relative ${searchResult.status === 'Lulus' ? 'bg-[#10b981]' : 'bg-red-500'}`}
                       >
                         ...
                         {searchResult.status === 'Lulus' ? (
                           <svg className="w-6 h-6 sm:w-10 sm:h-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
...
function ResultRow({ label, value, highlightValue = false }: { label: string, value: string, highlightValue?: boolean }) {
  return (
    <div className="flex justify-between items-start py-1.5 sm:py-3 border-b border-slate-100/80 last:border-0 gap-3 group">
