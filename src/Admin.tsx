                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-blue-100 flex flex-col gap-4">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-2 pt-4 border-t border-slate-100">
                        ...
                        <div className="flex gap-2 shrink-0">
                          <button onClick={() => setIsAdding(false)} className="px-4 py-2 bg-white hover:bg-slate-50 border border-slate-200 text-slate-600 hover:text-slate-800 rounded-lg transition-colors font-medium text-sm flex gap-2 items-center"><X className="w-4 h-4" /> Batal</button>
                          <button onClick={() => handleSave(true)} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-sm font-medium text-sm transition-all flex items-center gap-2"><Check className="w-4 h-4"/> Simpan Data</button>
                        </div>
                      </div>
