...
async function startServer() {
  ...
  app.post('/api/admin/students', authenticateAdmin, async (req, res) => {
    const { nama, nisn, tempatLahir, tglLahir, noPeserta, kelas, sekolah, status, tahunAjaran, isPranked } = req.body;
    try {
      const students = await readDB();
  ...
  app.put('/api/admin/students/:id', authenticateAdmin, async (req, res) => {
    ...
    try {
      ...
      students[index] = {
        ...students[index],
        nama, nisn, tempatLahir, tglLahir, noPeserta, kelas, sekolah,
        status: status || 'Lulus',
